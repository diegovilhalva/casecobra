...
import { Body, Column, Container, Head, Heading, Hr, Html, Img, Preview, Row, Text } from "@react-email/components"
...
const OrderReceivedEmail = ({ shippingAddress, orderId, orderDate }: { shippingAddress: ShippingAddress, orderId: string, orderDate: string }) => {
    const baseUrl =
        <Preview>Your order summary and estimated deleivery date</Preview>
    process.env.NODE_ENV === 'development'
        ? 'http://localhost:3000'
        : 'https://casecobra-eight-lac.vercel.app'
    return (
        <Html>
            <Head />
            <Body style={main}>
