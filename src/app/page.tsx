          ...
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              ...
              <p className="mt-8 text-lg lg:pr-10 max-w-prose text-center lg:text-left text-balance md:text-wrap">
                Capture your favorite memories on your own,{" "}
                <span className="font-semibold">on-of-one</span> phone case.
                CaseCobra allows you to protect your memories, not just you phone case.
              </p>
              ...
              <div className="mt-12 flex-col sm:flex-row items-center sm:items-start gap-5">
                ...
                <div className="flex flex-col justify-between items-center sm:items-start">
                  ...
                  <p><span className="font-simibold">1.250 </span>Happy customers</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="bg-slate-100 py-24">
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-32">
          <div className="flex flex-col lg:flex-row items-center gap-4 sm:gap-6">
            ...
            <img src="/snake-2.png" alt="snake logo" className="w-24 order-0 lg:order-2" />
          </div>
